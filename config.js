...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || '𝐈 𝐀𝐬𝐚𝐩;𝘏𝘵𝘵𝘱_𝘈𝘴𝘢𝘱;0;https://i.imgur.com/eQsjgkh.jpeg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "𝐀𝐬𝐚𝐩 𝐗𝐱",
    BOT_NAME: process.env.BOT_NAME || '𝐀𝐬𝐚𝐩',
